...
import earthSrc from "../assets/red.png";
import mountainSrc from "../assets/m2.jpg";
import ironSrc from "../assets/red1.png"
...
export class theEarth extends Container {
  ...
  async load(gl: WebGLRenderingContext) {
    ...
    const mountainTexture = new TextureBase(gl, await LoadImageAsync(mountainSrc))
